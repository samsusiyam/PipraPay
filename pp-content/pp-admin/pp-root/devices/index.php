                ...
                <div class="form-group mt-2">
                    ...
                    <div class="form-control-wrap">
                        <div class="input-group">
                            <input type="text" class="form-control" id="base-url" name="base-url" placeholder="https://yourdomain.com" value="<?php echo rtrim($site_url, '/'); ?>" oninput="iniModelConnectDevice()">
                        ...
                        <small class="form-hint mt-1 text-muted">For Android Emulator testing on localhost, you can change <code>localhost</code> to <code>10.0.2.2</code> or use your LAN IP.</small>
                    </div>
                </div>
